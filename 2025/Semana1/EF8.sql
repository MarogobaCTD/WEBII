...
CREATE TABLE [tbAlimento] (
    ...
    CONSTRAINT [PK__tbAlimen__2406570577A5EC2C] PRIMARY KEY ([IdAlimento])
);
GO

CREATE TABLE [tbCategoriaMedicamento] (
    [IdCategoriaMedicamento] int NOT NULL IDENTITY,
    [Nome] varchar(100) NOT NULL,
    [InformacaoComplementar] varchar(5000) NULL,
    CONSTRAINT [PK__tbCatego__14A80672AD9984E8] PRIMARY KEY ([IdCategoriaMedicamento])
);
GO

CREATE TABLE [tbEscalaBristol] (
    [IdEscalaBristol] int NOT NULL IDENTITY,
    [Nome] varchar(50) NOT NULL,
    [Sangue] bit NULL,
    CONSTRAINT [PK__tbEscala__A6FB417FE5BEBAC8] PRIMARY KEY ([IdEscalaBristol])
);
GO

CREATE TABLE [tbExame] (
    [IdExame] int NOT NULL IDENTITY,
    [Grupo] int NOT NULL,
    [Nome] varchar(100) NOT NULL,
    [Descricao] varchar(250) NULL,
    CONSTRAINT [PK__tbExame__0C2F360F255CCA14] PRIMARY KEY ([IdExame])
);
GO

CREATE TABLE [tbGrupoPatologico] (
    [IdGrupoPatologico] int NOT NULL IDENTITY,
    [Nome] varchar(100) NOT NULL,
    CONSTRAINT [PK__tbGrupoP__A7D4244D8473F997] PRIMARY KEY ([IdGrupoPatologico])
);
GO

CREATE TABLE [tbGruposReceitasDespesas] (
    [IdReceitaDespesa] int NOT NULL IDENTITY,
    [Tipo] int NOT NULL,
    [Nome] varchar(100) NOT NULL,
    CONSTRAINT [PK__tbGrupos__6D0EB5405BF2A8A2] PRIMARY KEY ([IdReceitaDespesa])
);
GO
...
CREATE TABLE [tbPais] (
    ...
    CONSTRAINT [PK__tbPais__FC850A7B0E4B8FB8] PRIMARY KEY ([IdPais])
);
GO

CREATE TABLE [tbPatologia] (
    [IdPatologia] int NOT NULL IDENTITY,
    [Nome] varchar(100) NOT NULL,
    [InformacaoComplementar] varchar(5000) NULL,
    CONSTRAINT [PK__tbPatolo__6D573A32CB2159DD] PRIMARY KEY ([IdPatologia])
);
GO
...
CREATE TABLE [tbPlano] (
    ...
    CONSTRAINT [PK__tbPlano__4C970C540297154D] PRIMARY KEY ([IdPlano])
);
GO

CREATE TABLE [tbSubstancia] (
    [IdSubstancia] int NOT NULL IDENTITY,
    [Nome] varchar(100) NOT NULL,
    [InformacaoComplementar] varchar(5000) NULL,
    CONSTRAINT [PK__tbSubsta__13276D321A469721] PRIMARY KEY ([IdSubstancia])
);
GO

CREATE TABLE [tbSuplemento] (
    [IdSuplemento] int NOT NULL IDENTITY,
    [IdTipoQuantidade] int NOT NULL,
    [Tipo] int NOT NULL,
    [Nome] varchar(100) NULL,
    ...
    [VitaminaA] float NOT NULL,
    [VitaminaB] float NOT NULL,
    CONSTRAINT [PK__tbSuplem__EC3A6B160D0E538F] PRIMARY KEY ([IdSuplemento])
);
GO

CREATE TABLE [tbTipoAcesso] (
    [IdTipoAcesso] int NOT NULL IDENTITY,
    [Nome] varchar(100) NOT NULL,
    [FlagAtivo] bit NOT NULL,
    CONSTRAINT [PK__tbTipoAc__FFC17AE5BEE97553] PRIMARY KEY ([IdTipoAcesso])
);
GO

CREATE TABLE [tbTipoProfissional] (
    [IdTipoProfissional] int NOT NULL IDENTITY,
    [Nome] varchar(100) NULL,
    CONSTRAINT [PK__tbTipoPr__358F03BEAA1B9B6E] PRIMARY KEY ([IdTipoProfissional])
);
GO
...
CREATE TABLE [tbMedicamento] (
    ...
    [Nome] varchar(100) NOT NULL,
    [Bula] varchar(max) NULL,
    [BulaArquivo] varbinary(max) NULL,
    CONSTRAINT [PK__tbMedica__AC96376E90E9D5E4] PRIMARY KEY ([IdMedicamento]),
    CONSTRAINT [FK__tbMedicam__IdCat__5812160E] FOREIGN KEY ([IdCategoriaMedicamento]) REFERENCES [tbCategoriaMedicamento] ([IdCategoriaMedicamento])
);
GO
...
CREATE TABLE [tbLancarReceitasDespesas] (
    ...
    CONSTRAINT [PK__tbLancar__2E531549C4400B28] PRIMARY KEY ([IdLancamento]),
    CONSTRAINT [FK__tbLancarR__IdRec__1EA48E88] FOREIGN KEY ([IdReceitaDespesa]) REFERENCES [tbGruposReceitasDespesas] ([IdReceitaDespesa])
);
GO
...
CREATE TABLE [tbEstado] (
    ...
    [Nome] varchar(100) NULL,
    [UF] varchar(2) NULL,
    CONSTRAINT [PK__tbEstado__FBB0EDC188F0ED55] PRIMARY KEY ([IdEstado]),
    CONSTRAINT [FK__tbEstado__IdPais__398D8EEE] FOREIGN KEY ([IdPais]) REFERENCES [tbPais] ([IdPais])
);
GO

CREATE TABLE [tbGrupoPatologico_X_Patologia] (
    [IdPatologia_X_GrupoPatologico] int NOT NULL IDENTITY,
    [IdGrupoPatologico] int NOT NULL,
    [IdPatologia] int NOT NULL,
    CONSTRAINT [PK__tbGrupoP__2BA30300C74D500A] PRIMARY KEY ([IdPatologia_X_GrupoPatologico]),
    CONSTRAINT [FK__tbGrupoPa__IdGru__5070F446] FOREIGN KEY ([IdGrupoPatologico]) REFERENCES [tbGrupoPatologico] ([IdGrupoPatologico]),
    CONSTRAINT [FK__tbGrupoPa__IdPat__5165187F] FOREIGN KEY ([IdPatologia]) REFERENCES [tbPatologia] ([IdPatologia])
);
GO
...
CREATE TABLE [tbContrato] (
    ...
    CONSTRAINT [PK__tbContra__8569F05AC291EB56] PRIMARY KEY ([IdContrato]),
    CONSTRAINT [FK__tbContrat__IdPla__412EB0B6] FOREIGN KEY ([IdPlano]) REFERENCES [tbPlano] ([IdPlano])
);
GO
...
CREATE TABLE [tbCidade] (
    ...
    [IdEstado] int NULL,
    [nome] varchar(100) NULL,
    CONSTRAINT [PK__tbCidade__160879A3F9A62446] PRIMARY KEY ([IdCidade]),
    CONSTRAINT [FK__tbCidade__IdEsta__3C69FB99] FOREIGN KEY ([IdEstado]) REFERENCES [tbEstado] ([IdEstado])
);
GO
...
CREATE TABLE [tbPaciente] (
    ...
    CONSTRAINT [PK__tbPacien__C93DB49B87CE1DFE] PRIMARY KEY ([IdPaciente]),
    CONSTRAINT [FK__tbPacient__IdCid__68487DD7] FOREIGN KEY ([IdCidade]) REFERENCES [tbCidade] ([IdCidade])
);
GO

CREATE TABLE [tbProfissional] (
    [IdProfissional] int NOT NULL IDENTITY,
    ...
    CONSTRAINT [PK__tbProfis__B9503FBCD9D3008C] PRIMARY KEY ([IdProfissional]),
    CONSTRAINT [FK__tbProfiss__IdCid__49C3F6B7] FOREIGN KEY ([IdCidade]) REFERENCES [tbCidade] ([IdCidade]),
    CONSTRAINT [FK__tbProfiss__IdCon__47DBAE45] FOREIGN KEY ([IdContrato]) REFERENCES [tbContrato] ([IdContrato]),
    CONSTRAINT [FK__tbProfiss__IdTip__48CFD27E] FOREIGN KEY ([IdTipoAcesso]) REFERENCES [tbTipoAcesso] ([IdTipoAcesso])
);
GO

CREATE TABLE [tbExame_X_Pacientes] (
    [IdExame_X_Paciente] int NOT NULL IDENTITY,
    [IdExame] int NOT NULL,
    [IdPaciente] int NOT NULL,
    [Data] date NULL,
    [Resultado] varchar(1000) NULL,
    CONSTRAINT [PK__tbExame___8F261547D75B06D7] PRIMARY KEY ([IdExame_X_Paciente]),
    CONSTRAINT [FK__tbExame_X__IdExa__08B54D69] FOREIGN KEY ([IdExame]) REFERENCES [tbExame] ([IdExame]),
    CONSTRAINT [FK__tbExame_X__IdPac__09A971A2] FOREIGN KEY ([IdPaciente]) REFERENCES [tbPaciente] ([IdPaciente])
);
GO

CREATE TABLE [tbHistoriaPatologica] (
    [IdHistoriaPatologica] int NOT NULL IDENTITY,
    [IdPaciente] int NOT NULL,
    ...
    CONSTRAINT [PK__tbHistor__86BDE8CF1E996F4D] PRIMARY KEY ([IdHistoriaPatologica]),
    CONSTRAINT [FK__tbHistori__IdPac__76969D2E] FOREIGN KEY ([IdPaciente]) REFERENCES [tbPaciente] ([IdPaciente]),
    CONSTRAINT [FK__tbHistori__IdPat__778AC167] FOREIGN KEY ([IdPatologia]) REFERENCES [tbPatologia] ([IdPatologia])
);
GO

CREATE TABLE [tbHistoricoAlimentarNutricional] (
    [IdHistAlimentarNutricional] int NOT NULL IDENTITY,
    [IdPaciente] int NOT NULL,
    [MotivacaoTratamento] int NULL,
    [ModismosAlimentares] int NULL,
    [FlgIntoleanciaAlimentar] bit NULL,
    [DescIntoleranciaAlimentar] varchar(250) NULL,
    ...
    [FlgDietas] bit NULL,
    [DescDietas] varchar(250) NULL,
    [FlgMedicamentos] bit NULL,
    [DescMedicamentos] varchar(250) NULL,
    [FlgExercicios] bit NULL,
    [DescExercicios] varchar(250) NULL,
    [FlgOutros] bit NULL,
    [DescOutros] varchar(250) NULL,
    [Obs] varchar(500) NULL,
    CONSTRAINT [PK__tbHistor__43605910B8D41005] PRIMARY KEY ([IdHistAlimentarNutricional]),
    CONSTRAINT [FK__tbHistori__IdPac__00200768] FOREIGN KEY ([IdPaciente]) REFERENCES [tbPaciente] ([IdPaciente])
);
GO

CREATE TABLE [tbHistoricoDoencaAtual] (
    [IdHDA] int NOT NULL IDENTITY,
    [IdPaciente] int NOT NULL,
    [IdPatologia] int NULL,
    ...
    [Metastase] int NULL,
    [Queimadura] int NULL,
    [ObsNeoplasia] varchar(250) NULL,
    [ObsMetastase] varchar(250) NULL,
    [ObsQueimadura] varchar(250) NULL,
    [Outros] varchar(250) NULL,
    CONSTRAINT [PK__tbHistor__0B5E79E21AD7740A] PRIMARY KEY ([IdHDA]),
    CONSTRAINT [FK__tbHistori__IdPac__72C60C4A] FOREIGN KEY ([IdPaciente]) REFERENCES [tbPaciente] ([IdPaciente]),
    CONSTRAINT [FK__tbHistori__IdPat__73BA3083] FOREIGN KEY ([IdPatologia]) REFERENCES [tbPatologia] ([IdPatologia])
);
GO

CREATE TABLE [tbHistoricoSocialAlimentar] (
    [IdHistSocialAlimentar] int NOT NULL IDENTITY,
    [IdPaciente] int NOT NULL,
    ...
    [NomeCompraAlimento] varchar(100) NULL,
    [NomeCozinhaAlimento] varchar(100) NULL,
    [CompraFeita] int NULL,
    [NomeRealizaRefeicao] varchar(100) NULL,
    ...
    CONSTRAINT [PK__tbHistor__7735810FEB315D96] PRIMARY KEY ([IdHistSocialAlimentar]),
    CONSTRAINT [FK__tbHistori__IdPac__7D439ABD] FOREIGN KEY ([IdPaciente]) REFERENCES [tbPaciente] ([IdPaciente])
);
GO

CREATE TABLE [tbHoraPaciente_Profissional] (
    [IdHoraPaciente_Profissional] int NOT NULL IDENTITY,
    [IdPaciente] int NOT NULL,
    ...
    CONSTRAINT [PK__tbHoraPa__A67184260E014819] PRIMARY KEY ([IdHoraPaciente_Profissional]),
    CONSTRAINT [FK__tbHoraPac__IdPac__6EF57B66] FOREIGN KEY ([IdPaciente]) REFERENCES [tbPaciente] ([IdPaciente]),
    CONSTRAINT [FK__tbHoraPac__IdPro__6FE99F9F] FOREIGN KEY ([IdProfissional]) REFERENCES [tbProfissional] ([IdProfissional])
);
GO

CREATE TABLE [tbMedico_Paciente] (
    [IdMedico_Paciente] int NOT NULL IDENTITY,
    [IdPaciente] int NOT NULL,
    [IdProfissional] int NOT NULL,
    [InformacaoResumida] varchar(5000) NULL,
    CONSTRAINT [PK__tbMedico__1F0BE44C0A2AD1D5] PRIMARY KEY ([IdMedico_Paciente]),
    CONSTRAINT [FK__tbMedico___IdPac__6B24EA82] FOREIGN KEY ([IdPaciente]) REFERENCES [tbPaciente] ([IdPaciente]),
    CONSTRAINT [FK__tbMedico___IdPro__6C190EBB] FOREIGN KEY ([IdProfissional]) REFERENCES [tbProfissional] ([IdProfissional])
);
GO

CREATE TABLE [tbPergunta] (
    [IdPergunta] int NOT NULL IDENTITY,
    [IdProfissional] int NOT NULL,
    [Nome] varchar(500) NOT NULL,
    [Ativo] bit NOT NULL,
    CONSTRAINT [PK__tbPergun__6DC6D9A7D4EDA3D1] PRIMARY KEY ([IdPergunta]),
    CONSTRAINT [FK__tbPergunt__IdPro__0C85DE4D] FOREIGN KEY ([IdProfissional]) REFERENCES [tbProfissional] ([IdProfissional])
);
GO

CREATE TABLE [tbReceitaAlimentarPadrao] (
    [IdReceitaAlimentarPadrao] int NOT NULL IDENTITY,
    [IdProfissional] int NULL,
    [Nome] varchar(100) NOT NULL,
    [InformacaoComplementar] varchar(5000) NULL,
    CONSTRAINT [PK__tbReceit__63863561B967240D] PRIMARY KEY ([IdReceitaAlimentarPadrao]),
    CONSTRAINT [FK__tbReceita__IdPro__5EBF139D] FOREIGN KEY ([IdProfissional]) REFERENCES [tbProfissional] ([IdProfissional])
);
GO

CREATE TABLE [tbReceitaMedicaPadrao] (
    [IdReceitaMedicaPadrao] int NOT NULL IDENTITY,
    [IdProfissional] int NOT NULL,
    [Nome] varchar(50) NOT NULL,
    [InformacaoComplementar] varchar(5000) NULL,
    CONSTRAINT [PK__tbReceit__E6DF7D77D9F2691C] PRIMARY KEY ([IdReceitaMedicaPadrao]),
    CONSTRAINT [FK__tbReceita__IdPro__619B8048] FOREIGN KEY ([IdProfissional]) REFERENCES [tbProfissional] ([IdProfissional])
);
GO

CREATE TABLE [tbAntropometria] (
    [IdAntropometria] int NOT NULL IDENTITY,
    ...
    CONSTRAINT [PK__tbAntrop__53A9E5941381DBE2] PRIMARY KEY ([IdAntropometria]),
    CONSTRAINT [FK__tbAntropo__IdHor__02FC7413] FOREIGN KEY ([IdHoraPaciente_Profissional]) REFERENCES [tbHoraPaciente_Profissional] ([IdHoraPaciente_Profissional]),
    CONSTRAINT [FK__tbAntropo__IdPac__03F0984C] FOREIGN KEY ([IdPaciente]) REFERENCES [tbPaciente] ([IdPaciente])
);
GO

CREATE TABLE [tbEscalaBristol_Paciente_Consulta] (
    [IdEscalaBristol_Paciente_Consulta] int NOT NULL IDENTITY,
    [IdEscalaBristol] int NOT NULL,
    [IdPaciente] int NOT NULL,
    [IdHora_Paciente_Profissional] int NOT NULL,
    CONSTRAINT [PK__tbEscala__44B7B8966A35F545] PRIMARY KEY ([IdEscalaBristol_Paciente_Consulta]),
    CONSTRAINT [FK__tbEscalaB__IdEsc__17F790F9] FOREIGN KEY ([IdEscalaBristol]) REFERENCES [tbEscalaBristol] ([IdEscalaBristol]),
    CONSTRAINT [FK__tbEscalaB__IdHor__19DFD96B] FOREIGN KEY ([IdHora_Paciente_Profissional]) REFERENCES [tbHoraPaciente_Profissional] ([IdHoraPaciente_Profissional]),
    CONSTRAINT [FK__tbEscalaB__IdPac__18EBB532] FOREIGN KEY ([IdPaciente]) REFERENCES [tbPaciente] ([IdPaciente])
);
GO

CREATE TABLE [tbExameFisico] (
    [IdExameFisico] int NOT NULL IDENTITY,
    [IdHoraPaciente_Profissional] int NULL,
    [SNC] int NULL,
    [AtividadeFisica] int NULL,
    [TipoAtividadeFisica] varchar(1000) NULL,
    [Frequencia] int NULL,
    ...
    [Obs] varchar(500) NULL,
    CONSTRAINT [PK__tbExameF__C8897518CD27158B] PRIMARY KEY ([IdExameFisico]),
    CONSTRAINT [FK__tbExameFi__IdHor__7A672E12] FOREIGN KEY ([IdHoraPaciente_Profissional]) REFERENCES [tbHoraPaciente_Profissional] ([IdHoraPaciente_Profissional])
);
GO

CREATE TABLE [tbRastreamentoResposta] (
    [IdRastreamentoResposta] int NOT NULL IDENTITY,
    [IdPergunta] int NOT NULL,
    [VlrRespota] int NOT NULL,
    [IdParteCorpo] int NOT NULL,
    [Obs] varchar(500) NOT NULL,
    CONSTRAINT [PK__tbRastre__ABA70EB6ADFF52D5] PRIMARY KEY ([IdRastreamentoResposta]),
    CONSTRAINT [FK__tbRastrea__IdPer__0F624AF8] FOREIGN KEY ([IdPergunta]) REFERENCES [tbPergunta] ([IdPergunta])
);
GO

CREATE TABLE [tbReceitaAlimentarPadrao_X_Alimento] (
    [IdReceitaAlimentarPadrao_X_Alimento_X_QuantidadeAlimento] int NOT NULL IDENTITY,
    [IdReceitaAlimentarPadrao] int NOT NULL,
    [IdAlimento] int NOT NULL,
    [IdQuantidadeAlimento] int NOT NULL,
    [Periodicidade] varchar(100) NULL,
    [QuantoTempo] varchar(100) NULL,
    CONSTRAINT [PK__tbReceit__2843B293137E4EBF] PRIMARY KEY ([IdReceitaAlimentarPadrao_X_Alimento_X_QuantidadeAlimento]),
    CONSTRAINT [FK__tbReceita__IdAli__656C112C] FOREIGN KEY ([IdAlimento]) REFERENCES [tbAlimento] ([IdAlimento]),
    CONSTRAINT [FK__tbReceita__IdRec__6477ECF3] FOREIGN KEY ([IdReceitaAlimentarPadrao]) REFERENCES [tbReceitaAlimentarPadrao] ([IdReceitaAlimentarPadrao])
);
GO

CREATE TABLE [tbRastreamentoMetabolico] (
    [IdRastreamentoMetabolico] int NOT NULL IDENTITY,
    [IdRastreamentoResposta] int NOT NULL,
    [IdHoraPaciente_Profissional] int NOT NULL,
    [ObsGeral] varchar(1000) NULL,
    [Total] int NULL,
    CONSTRAINT [PK__tbRastre__E5AA062354B3AF6E] PRIMARY KEY ([IdRastreamentoMetabolico]),
    CONSTRAINT [FK__tbRastrea__IdHor__1332DBDC] FOREIGN KEY ([IdHoraPaciente_Profissional]) REFERENCES [tbHoraPaciente_Profissional] ([IdHoraPaciente_Profissional]),
    CONSTRAINT [FK__tbRastrea__IdRas__123EB7A3] FOREIGN KEY ([IdRastreamentoResposta]) REFERENCES [tbRastreamentoResposta] ([IdRastreamentoResposta])
);
GO
...
CREATE INDEX [IX_tbAntropometria_IdHoraPaciente_Profissional] ON [tbAntropometria] ([IdHoraPaciente_Profissional]);
GO

CREATE INDEX [IX_tbAntropometria_IdPaciente] ON [tbAntropometria] ([IdPaciente]);
GO

CREATE INDEX [IX_tbCidade_IdEstado] ON [tbCidade] ([IdEstado]);
GO

CREATE INDEX [IX_tbContrato_IdPlano] ON [tbContrato] ([IdPlano]);
GO

CREATE INDEX [IX_tbEscalaBristol_Paciente_Consulta_IdEscalaBristol] ON [tbEscalaBristol_Paciente_Consulta] ([IdEscalaBristol]);
GO

CREATE INDEX [IX_tbEscalaBristol_Paciente_Consulta_IdHora_Paciente_Profissional] ON [tbEscalaBristol_Paciente_Consulta] ([IdHora_Paciente_Profissional]);
GO

CREATE INDEX [IX_tbEscalaBristol_Paciente_Consulta_IdPaciente] ON [tbEscalaBristol_Paciente_Consulta] ([IdPaciente]);
GO

CREATE INDEX [IX_tbEstado_IdPais] ON [tbEstado] ([IdPais]);
GO

CREATE INDEX [IX_tbExame_X_Pacientes_IdExame] ON [tbExame_X_Pacientes] ([IdExame]);
GO

CREATE INDEX [IX_tbExame_X_Pacientes_IdPaciente] ON [tbExame_X_Pacientes] ([IdPaciente]);
GO

CREATE INDEX [IX_tbExameFisico_IdHoraPaciente_Profissional] ON [tbExameFisico] ([IdHoraPaciente_Profissional]);
GO

CREATE INDEX [IX_tbGrupoPatologico_X_Patologia_IdGrupoPatologico] ON [tbGrupoPatologico_X_Patologia] ([IdGrupoPatologico]);
GO

CREATE INDEX [IX_tbGrupoPatologico_X_Patologia_IdPatologia] ON [tbGrupoPatologico_X_Patologia] ([IdPatologia]);
GO

CREATE INDEX [IX_tbHistoriaPatologica_IdPaciente] ON [tbHistoriaPatologica] ([IdPaciente]);
GO

CREATE INDEX [IX_tbHistoriaPatologica_IdPatologia] ON [tbHistoriaPatologica] ([IdPatologia]);
GO

CREATE INDEX [IX_tbHistoricoAlimentarNutricional_IdPaciente] ON [tbHistoricoAlimentarNutricional] ([IdPaciente]);
GO

CREATE INDEX [IX_tbHistoricoDoencaAtual_IdPaciente] ON [tbHistoricoDoencaAtual] ([IdPaciente]);
GO

CREATE INDEX [IX_tbHistoricoDoencaAtual_IdPatologia] ON [tbHistoricoDoencaAtual] ([IdPatologia]);
GO

CREATE INDEX [IX_tbHistoricoSocialAlimentar_IdPaciente] ON [tbHistoricoSocialAlimentar] ([IdPaciente]);
GO

CREATE INDEX [IX_tbHoraPaciente_Profissional_IdPaciente] ON [tbHoraPaciente_Profissional] ([IdPaciente]);
GO

CREATE INDEX [IX_tbHoraPaciente_Profissional_IdProfissional] ON [tbHoraPaciente_Profissional] ([IdProfissional]);
GO

CREATE INDEX [IX_tbLancarReceitasDespesas_IdReceitaDespesa] ON [tbLancarReceitasDespesas] ([IdReceitaDespesa]);
GO

CREATE INDEX [IX_tbMedicamento_IdCategoriaMedicamento] ON [tbMedicamento] ([IdCategoriaMedicamento]);
GO

CREATE INDEX [IX_tbMedico_Paciente_IdPaciente] ON [tbMedico_Paciente] ([IdPaciente]);
GO

CREATE INDEX [IX_tbMedico_Paciente_IdProfissional] ON [tbMedico_Paciente] ([IdProfissional]);
GO

CREATE INDEX [IX_tbPaciente_IdCidade] ON [tbPaciente] ([IdCidade]);
GO

CREATE INDEX [IX_tbPergunta_IdProfissional] ON [tbPergunta] ([IdProfissional]);
GO

CREATE INDEX [IX_tbProfissional_IdCidade] ON [tbProfissional] ([IdCidade]);
GO

CREATE INDEX [IX_tbProfissional_IdContrato] ON [tbProfissional] ([IdContrato]);
GO

CREATE INDEX [IX_tbProfissional_IdTipoAcesso] ON [tbProfissional] ([IdTipoAcesso]);
GO

CREATE INDEX [IX_tbRastreamentoMetabolico_IdHoraPaciente_Profissional] ON [tbRastreamentoMetabolico] ([IdHoraPaciente_Profissional]);
GO

CREATE INDEX [IX_tbRastreamentoMetabolico_IdRastreamentoResposta] ON [tbRastreamentoMetabolico] ([IdRastreamentoResposta]);
GO

CREATE INDEX [IX_tbRastreamentoResposta_IdPergunta] ON [tbRastreamentoResposta] ([IdPergunta]);
GO

CREATE INDEX [IX_tbReceitaAlimentarPadrao_IdProfissional] ON [tbReceitaAlimentarPadrao] ([IdProfissional]);
GO

CREATE INDEX [IX_tbReceitaAlimentarPadrao_X_Alimento_IdAlimento] ON [tbReceitaAlimentarPadrao_X_Alimento] ([IdAlimento]);
GO

CREATE INDEX [IX_tbReceitaAlimentarPadrao_X_Alimento_IdReceitaAlimentarPadrao] ON [tbReceitaAlimentarPadrao_X_Alimento] ([IdReceitaAlimentarPadrao]);
GO

CREATE INDEX [IX_tbReceitaMedicaPadrao_IdProfissional] ON [tbReceitaMedicaPadrao] ([IdProfissional]);
GO
